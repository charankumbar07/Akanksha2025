...
`)
    ...
    return (
        <div className='flex flex-col items-center justify-center  text-white bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 font-sans antialiased w-screen h-screen'>
